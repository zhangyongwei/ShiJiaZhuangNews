...
public class GuideActivity extends AppCompatActivity {
    ...
    private void initData() {
       ...
       viewpager.setAdapter(new MyPagerAdapter());
        //监听页面的改变
        viewpager.addOnPageChangeListener(new MyOnPageChangeLinstener());
        //根据多少个页面添加多少个灰点
    ...
    class MyOnPageChangeLinstener implements ViewPager.OnPageChangeListener{
        /**
         * 当滑动了页面时的回调
         * @param position      当前滑动页面的位置
         * @param positionOffset 当前滑动的百分比
         * @param positionOffsetPixels 当前滑动的单位(像数)
         */
        @Override
